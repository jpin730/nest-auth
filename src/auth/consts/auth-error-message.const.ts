export const AUTH_ERROR_MESSAGE = {
  ...
  UNAVAILABLE_REFRESH: 'Unable to refresh token at the moment, please try again later',
  UNAVAILABLE_REGISTER: 'Unable to register at the moment, please try again later',
} as const
